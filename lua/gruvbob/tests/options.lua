local base_palette = require('gruvbob.colors.gruvbob')

local assert_eq = require('gruvbob.utils').assert_eq
local load = require('gruvbob').load
local get_highlight = require('gruvbob.utils').get_highlight
...
local blend = require('gruvbob.utils').blend
assert_eq(
    get_highlight('CursorLine').bg,
